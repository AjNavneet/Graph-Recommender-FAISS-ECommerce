...
# Save the raw unweighted directed graph to a Parquet file
...
# Directed Weighted Graph: Weight is Co-occurrence count of two products
...
# Save the directed weighted graph to a Parquet file
directed_weighted_graph.to_parquet('../Data/ConstructedGraph/directed_weighted_product_views_graph.parquet', index=False)

# Undirected Weighted Graph: Weight is Co-occurrence count of two products
...
# Save the undirected weighted graph to a Parquet file
